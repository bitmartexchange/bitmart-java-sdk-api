...
import com.bitmart.api.request.spot.prv.v4.V4QueryOrderByClientOrderIdRequest;
...
@Slf4j
public class QueryOrderByClientOrderId {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // The response now includes new fields:
