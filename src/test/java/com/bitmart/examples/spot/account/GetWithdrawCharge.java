...
import com.bitmart.api.request.account.prv.AccountWithdrawChargeRequest;
...
@Slf4j
public class GetWithdrawCharge {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Get withdraw charge for BMX
            final CloudResponse cloudResponse = call.callCloud(new AccountWithdrawChargeRequest()
                    .setCurrency("BMX"));
            System.out.println("BMX withdraw charge: " + cloudResponse.getResponseContent());

            // Get withdraw charge for USDT
            final CloudResponse cloudResponse2 = call.callCloud(new AccountWithdrawChargeRequest()
                    .setCurrency("USDT-ETH"));
            System.out.println("USDT-ETH withdraw charge: " + cloudResponse2.getResponseContent());
