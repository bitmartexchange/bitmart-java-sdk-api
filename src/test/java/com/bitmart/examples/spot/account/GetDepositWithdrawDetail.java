...
import com.bitmart.api.request.account.prv.AccountDepositWithdrawDetailRequest;
...
@Slf4j
public class GetDepositWithdrawDetail {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Get deposit/withdraw detail by ID
            final CloudResponse cloudResponse = call.callCloud(new AccountDepositWithdrawDetailRequest()
                    .setId(1679947L));
            System.out.println("Deposit/Withdraw detail: " + cloudResponse.getResponseContent());
