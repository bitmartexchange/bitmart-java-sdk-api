...
public class TestData {
    ...
    public static String CLOUD_WS_URL = "wss://openapi-ws.bitmart.com/api?protocol=1.1";
    public static String CLOUD_WS_PRIVATE_URL = "wss://openapi-ws.bitmart.com/user?protocol=1.1";
