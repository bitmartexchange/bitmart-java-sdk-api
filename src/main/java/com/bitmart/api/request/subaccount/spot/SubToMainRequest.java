...
/**
 * Sub-Account (spot) — sub-account spot wallet transfer to main account (for main account)
 */
@EqualsAndHashCode(callSuper = true)
@Data
@ToString
@Accessors(chain = true)
public class SubToMainRequest extends CloudRequest {
    ...
    public SubToMainRequest() {
        super("/account/sub-account/main/v1/sub-to-main", Method.POST, Auth.SIGNED);
    }
}
