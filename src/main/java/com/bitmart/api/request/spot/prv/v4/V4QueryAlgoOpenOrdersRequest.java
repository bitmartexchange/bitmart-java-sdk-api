...
/**
 * Algo order (V4) — query the current (open) strategy orders
 */
@EqualsAndHashCode(callSuper = true)
@Data
@ToString
@Accessors(chain = true)
public class V4QueryAlgoOpenOrdersRequest extends CloudRequest {
    ...
    public V4QueryAlgoOpenOrdersRequest() {
        super("/spot/v4/query/algo/open-orders", Method.POST, Auth.SIGNED);
    }
}
