...
public class MarkPriceKlineRequest extends CloudRequest {
    ...
    /**
     * Applicable for querying MarkPrice K-line data
     */
    public MarkPriceKlineRequest() {
        super("/contract/public/markprice-kline", Method.GET, Auth.NONE);
    }
}
